...
3. Text continues loading dynamically until the countdown finishes  
4. WPM and accuracy are calculated in real time  
5. Final results are shown when time is up  
